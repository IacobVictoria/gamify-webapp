<template>
    <div class="flex flex-col items-center text-center mt-12">
        <h2 class="text-2xl font-extrabold">Câștigă recompense scanând coduri QR!</h2>
        <p class="mt-2 text-lg opacity-80">
            Scanează codul QR de pe produsele achiziționate și adună puncte
            pentru a debloca insigne și beneficii exclusive! 🎉
        </p>
