<template>
    <div class="flex flex-col gap-8 px-4 my-20">
        <div class="flex flex-row items-center justify-between">
            <span class="text-lg font-medium leading-none">Topul jucatorilor</span>
        </div>
        <!-- Top 3 container -->
        <div class="flex items-end justify-center gap-4">
            <!-- Locul 3 -->
            <div class="flex flex-col items-center">
                <img v-if="top10Players[2].gender === 'Male'" src="/images/male.png" alt="User Avatar"
                    class="w-14 h-14 rounded-full" />
                <img v-else src="/images/female.png" alt="User Avatar" class="w-14 h-14 rounded-full" />
                <p class="text-sm mt-2">{{ formatName(top10Players[2].name) }}</p>
                <p class="text-[#613D7B]">{{ top10Players[2].score }} px</p>
                <div class="min-w-[105px] min-h-[85px] py-[21.97px] bg-[#A08BB0] py-2 px-4 rounded-md">
                    <div class="flex flex-col items-center justify-center">
                        <span class="text-lg font-semibold leading-snug">Locul</span>
                        <span class="text-lg font-semibold leading-snug">3</span>
                    </div>
                </div>
            </div>
            ...
            <!-- Locul 1 -->
            <div class="flex flex-col items-center">
                <img v-if="top10Players[0].gender === 'Male'" src="/images/male.png" alt="User Avatar"
                    class="w-14 h-14 rounded-full" />
                <img v-else src="/images/female.png" alt="User Avatar" class="w-14 h-14 rounded-full" />
                <p class="text-sm mt-2">{{ formatName(top10Players[0].name) }}</p>
                ...
                <div
                    ...
                    <div class="flex flex-col items-center justify-center">
                        <span class="text-lg font-semibold leading-snug">Locul</span>
                        <span class="text-lg font-semibold leading-snug">1</span>
                    </div>
                </div>
            </div>
            ...
            <!-- Locul 2 -->
            <div class="flex flex-col items-center">
                <img v-if="top10Players[1].gender === 'Male'" src="/images/male.png" alt="User Avatar"
                    class="w-14 h-14 rounded-full" />
                <img v-else src="/images/female.png" alt="User Avatar" class="w-14 h-14 rounded-full" />
                <p class="text-sm mt-2">{{ formatName(top10Players[1].name) }}</p>
                ...
                <div
                    ...
                    <div class="flex flex-col items-center justify-center pt-2">
                        <span class="text-lg font-semibold leading-snug">Locul</span>
                        <span class="text-lg font-semibold leading-snug">2</span>
                    </div>
                </div>
            </div>
        </div>
        <div v-for="player in top10Players.slice(3)" :key="player.id"
            class="flex items-center gap-4 bg-[#EBE0F4] py-7 px-4 rounded-xl w-12/12">
            <span class="text-base font-semibold leading-tight w-2/12">#{{ getPlayerPosition(player) }}</span>
            <span class="text-[13px] font-[500] leading-none w-10/12">{{ player.name }}</span>
            <span class="text-xs font-normal leading-[14.88px] w-2/12">{{ player.score }} px</span>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        getPlayerPosition(player) {
            let playerIndex = this.top10Players.findIndex((p) => p.id === player.id);
