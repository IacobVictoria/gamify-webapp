<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            ...
            >
                🎮 Dashboard de joc - Urcă în nivel! 🚀
            </h2>
        </template>
        <div class="py-12">
            <div class="max-w-[90%] mx-auto sm:px-6">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="flex flex-row gap-5 px-4 m-12">
                        ...
                        <div>
                            <span
                                class="text-xl font-normal leading-snug tracking-tight"
                                >Salut,
                            </span>
                            <span
                                class="text-xl font-semibold leading-snug tracking-tight"
                                >{{ account.name }}!</span
                            >
                            <div class="flex flex-col max-w-[241px] mt-2">
                                <h2
                                    class="max-w-full text-sm font-semibold text-[#FA902F] capitalize"
                                >
                                    {{ userRank }}
                                </h2>
                                ...
                                <!-- Progress Bar -->
                                <div
                                    class="relative w-full h-3 bg-gray-200 rounded-full overflow-hidden mt-1.5"
                                >
                                    <div
                                        :class="progressClass"
                                ...
                                >
                                    <span class="text-[#CD7F32]">Bronz</span>
    ...
    computed: {
        ...
        userRank() {
            if (this.account.score >= 50 && this.account.score < 100) {
                return "Jucător Bronz";
            } else if (this.account.score >= 100 && this.account.score < 300) {
                return "Jucător Argint";
            } else if (this.account.score > 300) {
                return "Campion de Aur";
            } else {
                return "Jucător Nou";
            }
        },
