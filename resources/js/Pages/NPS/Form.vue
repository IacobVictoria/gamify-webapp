                    ...
                    <div class="mx-auto px-6 pb-16 pt-24 sm:pt-40">
                        <div class="p-8 bg-white shadow-2xl rounded-lg">
                            <div class="mb-8 text-center">
                                <h2
                                    class="text-3xl font-bold text-indigo-600 mb-2 flex items-center justify-center"
                                >
                                    📝 {{ survey.title }}
                                </h2>
                            ...
                            <div class="space-y-6">
                                ...
                                >
                                    <div
                                        class="mb-3 font-semibold text-gray-800 text-lg flex items-center"
                                    >
                                        <i
                                            class="fa fa-question-circle text-indigo-500 mr-2"
                                        ></i>
                                        {{ question.text }}
                                    </div>
        ...
        async submitFeedback() {
            if (!this.isValidFeedback) {
                Swal.fire({
                    icon: "warning",
                    title: "Incomplete!",
                    text: "Te rugăm să răspunzi la toate întrebările înainte de a trimite.",
            ...
            try {
                ...
                Swal.fire({
                    title: "Mulțumim pentru răspuns!",
                    text: "Feedback-ul tău a fost înregistrat cu succes.",
                    icon: "success",
                    confirmButtonText: "OK",
                }).then(() => {
                ...
                Swal.fire({
                    title: "Eroare!",
                    text: "A apărut o problemă la trimiterea feedback-ului.",
                    icon: "error",
                    confirmButtonText: "Reîncearcă",
                });
            }
        },
        resetForm() {
