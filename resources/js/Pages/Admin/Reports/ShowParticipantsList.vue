<template>
    <div class="bg-white p-8">
        <AuthenticatedLayout>
            <header class="mb-8">
                <h1 class="text-3xl font-bold text-gray-800 text-center mt-32">Participants List Reports</h1>
            </header>
            ...
            <main>
                ...
                <div v-else class="text-center">
                    <p class="text-gray-500">No reports available for this period.</p>
                </div>
            </main>
        </AuthenticatedLayout>
    </div>
...
export default {
    props: {
        groupedReports: Object, // Gruparea rapoartelor pe săptămâni
        year: String,
        month: String,
    },
    data() {
