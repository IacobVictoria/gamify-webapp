<template>
    <footer class="bg-[#334155] text-white">
        <div class="max-w-7xl mx-auto px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
            <div class="flex flex-col items-start md:flex-row md:items-center md:justify-between">
                <img
                    class="h-7 mb-4 md:mb-0"
            ...
            <div class="mt-16 border-t border-white/10 pt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="p-6">
